...
|--|--|
| [CANN 9.1.0](https://www.hiascend.com/developer/download/community/result?module=cann&cann=9.1.0-beta.2) | [Ascend HDK 26.0.RC1 ](https://www.hiascend.com/hardware/firmware-drivers/community?product=4&model=32&cann=All&driver=Ascend+HDK+26.0.RC1)<br> [Ascend HDK 25.5.2 ](https://www.hiascend.com/hardware/firmware-drivers/community?product=4&model=32&cann=All&driver=Ascend+HDK+25.5.2) <br> [Ascend HDK 25.5.1](https://www.hiascend.com/hardware/firmware-drivers/community?product=4&model=32&cann=All&driver=Ascend+HDK+25.5.1) |

**2、 CANN组合包版本配套关系**

|ops版本  |配套toolkit版本  |
|--|--|
|[ascend-cann-ops 9.1.0](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/) | [ascend-cann-toolkit 9.1.0-beta.2](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/)|

**3、 CANN独立升级子包版本配套关系**
| CANN子包版本                                                 | 版本源码标签                                                 | 配套CANN版本      |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ----------------- |
| [cann-ops-math 9.1.0](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/) | [v9.1.0-beta.2](https://gitcode.com/cann/ops-math/tags/v9.1.0-beta.2) | CANN 9.1.0-beta.2 |
| [cann-ops-nn 9.1.0](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/) | [v9.1.0-beta.2](https://gitcode.com/cann/ops-nn/tags/v9.1.0-beta.2) | CANN 9.1.0-beta.2 |
| [cann-ops-cv 9.1.0](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/) | [v9.1.0-beta.2](https://gitcode.com/cann/ops-cv/tags/v9.1.0-beta.2) | CANN 9.1.0-beta.2 |
| [cann-ops-transformer 9.1.0](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/) | [v9.1.0-beta.2](https://gitcode.com/cann/ops-transformer/tags/v9.1.0-beta.2) | CANN 9.1.0-beta.2 |
| [cann-hccl 9.1.0](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/) | [v9.1.0-beta.2](https://gitcode.com/cann/hccl/tags/v9.1.0-beta.2) | CANN 9.1.0-beta.2 |
| [cann-hixl 9.1.0](https://ascend.devcloud.huaweicloud.com/cann/run/software/9.1.0-beta.2/) | [v9.1.0-beta.2](https://gitcode.com/cann/hixl/tags/v9.1.0-beta.2) | CANN 9.1.0-beta.2 |

**4、CANN开源子包版本配套关系**

| CANN子包版本                       | 版本源码标签                                                 | 配套CANN版本      |
| ---------------------------------- | ------------------------------------------------------------ | ----------------- |
| cann-opbase 9.1.0           | [v9.1.0-beta.2](https://gitcode.com/cann/opbase/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-oam-tools 9.1.0        | [v9.1.0-beta.2](https://gitcode.com/cann/oam-tools/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-asc-tools 9.1.0        | [v9.1.0-beta.2](https://gitcode.com/cann/asc-tools/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-asc-devkit 9.1.0       | [v9.1.0-beta.2](https://gitcode.com/cann/asc-devkit/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-pto-isa 9.1.0          | [v9.1.0-beta.2](https://gitcode.com/cann/pto-isa/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-ge-compiler 9.1.0     | [v9.1.0-beta.2](https://gitcode.com/cann/ge/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-ge-executor 9.1.0      | [v9.1.0-beta.2](https://gitcode.com/cann/ge/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-graph-autofusion 9.1.0 | [v9.1.0-beta.2](https://gitcode.com/cann/graph-autofusion/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-metadef 9.1.0        | [v9.1.0-beta.2](https://gitcode.com/cann/metadef/tags/v9.1.0-beta.2) | CANN 9.1.0 |
| cann-dflow-executor 9.1.0   | [v9.1.0-beta.2](https://gitcode.com/cann/ge/tags/v9.1.0-beta.2) | CANN 9.1.0|
| cann-hcomm 9.1.0           | [v9.1.0-beta.2](https://gitcode.com/cann/hcomm/tags/v9.1.0-beta.2) | CANN 9.1.0|
| cann-npu-runtime 9.1.0      | [v9.1.0-beta.2](https://gitcode.com/cann/runtime/tags/v9.1.0-beta.2) | CANN 9.1.0|

子包独立升级的具体操作请参考[子包独立升级](#子包独立升级)。

## 关键特性

**DeepSeekV4加速：新增SMLA系列/mHC系列算子支持**

在Atlas A2 系列产品和Atlas A3 系列产品上，新增支持SMLA正反向/mHC正反向算子，模型提升至1.3+([SMLA](https://gitcode.com/cann/ops-transformer/blob/9.1.0/attention/sparse_flash_mla/docs/aclnnSparseFlashMla.md),[SMLAG](https://gitcode.com/cann/ops-transformer/blob/9.1.0/attention/sparse_flash_mla_grad/docs/aclnnSparseFlashMlaGrad.md),[LI](https://gitcode.com/cann/ops-transformer/blob/9.1.0/attention/lightning_indexer_v2/docs/aclnnLightningIndexerV2.md),[SLIG](https://gitcode.com/cann/ops-transformer/blob/9.1.0/attention/sparse_lightning_indexer_kl_loss_grad/docs/aclnnSparseLightningIndexerKLLossGrad.md),[mhc](https://gitcode.com/cann/ops-transformer/tree/9.1.0/mhc))。

**MOE结构加速：新增MegaMoe通算融合算子支持**

在Atlas A2 系列产品和Atlas A3 系列产品上，支持[MegaMoe](https://gitcode.com/cann/ops-transformer/blob/9.1.0/mc2/mega_moe/README.md)通算算子，在Deepseek/Qwen/GLM系列模型提升至1.2+。

**发布Host CPU 亲和性绑核工具：**  
在Atlas A3/A5系列产品支持Host CPU性能调优，支持Host CPU 亲和性绑核与资源隔离([msboost](https://gitcode.com/Ascend/msboost))。

**提供AICore直驱的通信编程接口：**

在Ascend 950产品，SHMEM 首发支持 AICore 直驱 MTE/UDMA/RDMA，使能UB和RoCE通信，提供相应编程接口。
